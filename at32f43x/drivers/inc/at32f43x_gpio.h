/**
  **************************************************************************
  * @file     at32f43x_gpio.h
  * @version  v2.0.8
  * @date     2022-04-25
  * @brief    at32f43x gpio header file
  **************************************************************************
...
#ifndef __AT32F43X_GPIO_H
#define __AT32F43X_GPIO_H
...
#define AT32_GPIO_PINS_0                       0x0001 /*!< gpio pins number 0 */
#define AT32_GPIO_PINS_1                       0x0002 /*!< gpio pins number 1 */
#define AT32_GPIO_PINS_2                       0x0004 /*!< gpio pins number 2 */
#define AT32_GPIO_PINS_3                       0x0008 /*!< gpio pins number 3 */
#define AT32_GPIO_PINS_4                       0x0010 /*!< gpio pins number 4 */
#define AT32_GPIO_PINS_5                       0x0020 /*!< gpio pins number 5 */
#define AT32_GPIO_PINS_6                       0x0040 /*!< gpio pins number 6 */
#define AT32_GPIO_PINS_7                       0x0080 /*!< gpio pins number 7 */
#define AT32_GPIO_PINS_8                       0x0100 /*!< gpio pins number 8 */
#define AT32_GPIO_PINS_9                       0x0200 /*!< gpio pins number 9 */
#define AT32_GPIO_PINS_10                      0x0400 /*!< gpio pins number 10 */
#define AT32_GPIO_PINS_11                      0x0800 /*!< gpio pins number 11 */
#define AT32_GPIO_PINS_12                      0x1000 /*!< gpio pins number 12 */
#define AT32_GPIO_PINS_13                      0x2000 /*!< gpio pins number 13 */
#define AT32_GPIO_PINS_14                      0x4000 /*!< gpio pins number 14 */
#define AT32_GPIO_PINS_15                      0x8000 /*!< gpio pins number 15 */
#define AT32_GPIO_PINS_ALL                     0xFFFF /*!< gpio all pins */
...
typedef enum
{
  AT32_GPIO_MODE_INPUT                        = 0x00, /*!< gpio input mode */
  AT32_GPIO_MODE_OUTPUT                       = 0x01, /*!< gpio output mode */
  AT32_GPIO_MODE_MUX                          = 0x02, /*!< gpio mux function mode */
  AT32_GPIO_MODE_ANALOG                       = 0x03  /*!< gpio analog in/out mode */
} gpio_mode_type;
...
typedef enum
{
  AT32_GPIO_DRIVE_STRENGTH_STRONGER           = 0x01, /*!< stronger sourcing/sinking strength */
  AT32_GPIO_DRIVE_STRENGTH_MODERATE           = 0x02  /*!< moderate sourcing/sinking strength */
} gpio_drive_type;
...
typedef enum
{
  AT32_GPIO_OUTPUT_PUSH_PULL                  = 0x00, /*!< output push-pull */
  AT32_GPIO_OUTPUT_OPEN_DRAIN                 = 0x01  /*!< output open-drain */
} gpio_output_type;
...
typedef enum
{
  AT32_GPIO_PULL_NONE                         = 0x00, /*!< floating for input, no pull for output */
  AT32_GPIO_PULL_UP                           = 0x01, /*!< pull-up */
  AT32_GPIO_PULL_DOWN                         = 0x02  /*!< pull-down */
} gpio_pull_type;
...
typedef enum
{
  AT32_GPIO_PINS_SOURCE0                      = 0x00, /*!< gpio pins source number 0 */
  AT32_GPIO_PINS_SOURCE1                      = 0x01, /*!< gpio pins source number 1 */
  AT32_GPIO_PINS_SOURCE2                      = 0x02, /*!< gpio pins source number 2 */
  AT32_GPIO_PINS_SOURCE3                      = 0x03, /*!< gpio pins source number 3 */
  AT32_GPIO_PINS_SOURCE4                      = 0x04, /*!< gpio pins source number 4 */
  AT32_GPIO_PINS_SOURCE5                      = 0x05, /*!< gpio pins source number 5 */
  AT32_GPIO_PINS_SOURCE6                      = 0x06, /*!< gpio pins source number 6 */
  AT32_GPIO_PINS_SOURCE7                      = 0x07, /*!< gpio pins source number 7 */
  AT32_GPIO_PINS_SOURCE8                      = 0x08, /*!< gpio pins source number 8 */
  AT32_GPIO_PINS_SOURCE9                      = 0x09, /*!< gpio pins source number 9 */
  AT32_GPIO_PINS_SOURCE10                     = 0x0A, /*!< gpio pins source number 10 */
  AT32_GPIO_PINS_SOURCE11                     = 0x0B, /*!< gpio pins source number 11 */
  AT32_GPIO_PINS_SOURCE12                     = 0x0C, /*!< gpio pins source number 12 */
  AT32_GPIO_PINS_SOURCE13                     = 0x0D, /*!< gpio pins source number 13 */
  AT32_GPIO_PINS_SOURCE14                     = 0x0E, /*!< gpio pins source number 14 */
  AT32_GPIO_PINS_SOURCE15                     = 0x0F  /*!< gpio pins source number 15 */
...
typedef enum
{
  AT32_GPIO_MUX_0                             = 0x00, /*!< gpio muxing function selection 0 */
  AT32_GPIO_MUX_1                             = 0x01, /*!< gpio muxing function selection 1 */
  AT32_GPIO_MUX_2                             = 0x02, /*!< gpio muxing function selection 2 */
  AT32_GPIO_MUX_3                             = 0x03, /*!< gpio muxing function selection 3 */
  AT32_GPIO_MUX_4                             = 0x04, /*!< gpio muxing function selection 4 */
  AT32_GPIO_MUX_5                             = 0x05, /*!< gpio muxing function selection 5 */
  AT32_GPIO_MUX_6                             = 0x06, /*!< gpio muxing function selection 6 */
  AT32_GPIO_MUX_7                             = 0x07, /*!< gpio muxing function selection 7 */
  AT32_GPIO_MUX_8                             = 0x08, /*!< gpio muxing function selection 8 */
  AT32_GPIO_MUX_9                             = 0x09, /*!< gpio muxing function selection 9 */
  AT32_GPIO_MUX_10                            = 0x0A, /*!< gpio muxing function selection 10 */
  AT32_GPIO_MUX_11                            = 0x0B, /*!< gpio muxing function selection 11 */
  AT32_GPIO_MUX_12                            = 0x0C, /*!< gpio muxing function selection 12 */
  AT32_GPIO_MUX_13                            = 0x0D, /*!< gpio muxing function selection 13 */
  AT32_GPIO_MUX_14                            = 0x0E, /*!< gpio muxing function selection 14 */
  AT32_GPIO_MUX_15                            = 0x0F  /*!< gpio muxing function selection 15 */
} gpio_mux_sel_type;
