...
void gpio_default_para_init(gpio_init_type *gpio_init_struct)
{
  ...
  gpio_init_struct->gpio_pins  = AT32_GPIO_PINS_ALL;
  gpio_init_struct->gpio_mode = AT32_GPIO_MODE_INPUT;
  gpio_init_struct->gpio_out_type = AT32_GPIO_OUTPUT_PUSH_PULL;
  gpio_init_struct->gpio_pull = AT32_GPIO_PULL_NONE;
  gpio_init_struct->gpio_drive_strength = AT32_GPIO_DRIVE_STRENGTH_STRONGER;
}
