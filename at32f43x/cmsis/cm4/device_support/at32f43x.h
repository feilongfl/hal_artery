...
/**
  ...
  */
    ...
    #error "Please select first the target device used in your application (in at32f43x.h file)"
#endif
...
/**
  * @brief at32f43x standard peripheral library version number
  */
#define __AT32F43X_LIBRARY_VERSION_MAJOR    (0x02) /*!< [31:24] major version */
#define __AT32F43X_LIBRARY_VERSION_MIDDLE   (0x00) /*!< [23:16] middle version */
#define __AT32F43X_LIBRARY_VERSION_MINOR    (0x08) /*!< [15:8]  minor version */
#define __AT32F43X_LIBRARY_VERSION_RC       (0x00) /*!< [7:0]  release candidate */
#define __AT32F43X_LIBRARY_VERSION          ((__AT32F43X_LIBRARY_VERSION_MAJOR << 24)  | \
                                                 (__AT32F43X_LIBRARY_VERSION_MIDDLE << 16) | \
                                                 (__AT32F43X_LIBRARY_VERSION_MINOR << 8)   | \
                                                 (__AT32F43X_LIBRARY_VERSION_RC))
...
/**
  * @brief at32f43x interrupt number definition, according to the selected device
...
#include "at32f43x_def.h"
#include "at32f43x_conf.h"
